    ...
    def apply_rule_based_anomaly_detection(self, df):
        ...
        return df \
            .withColumn("anomaly_score", 
                ...
                .when(col("is_slow") & (col("response_time") > 2000), 0.8)  # Very slow responses
                .when(col("is_slow"), 0.6)  # Slow responses
                .when(col("is_error"), 0.5)  # Regular errors
                .when(col("response_time") > 500, 0.3)  # Medium response times
